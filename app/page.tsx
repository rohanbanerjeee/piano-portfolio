...
export default function Home() {
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      {/* Content with overlay gradient - lighter to show red better */}
      <div className="relative min-h-screen bg-gradient-to-b from-zinc-900/70 via-zinc-950/80 to-black/85 flex flex-col items-center justify-end p-0 pb-0">
        {/* Header */}
